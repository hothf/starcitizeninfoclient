 ...
 * 
 */
public class NewsDBContentprovider extends android.content.ContentProvider {

	private NewsDBHelper dbHelper;
	private static final String AUTHORITY = "de.kauz.starcitizen.informer.databases.NewsDBContentprovider";
	public static final String BASE_PATH = "news";
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		case CODE:
			rowsDeleted = sqlDB.delete(
					NewsDBContract.DataBaseEntry.TABLE_NAME, selection,
					selectionArgs);
			break;
		case CODE_ID:
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		switch (uriType) {
		case CODE:
			id = sqlDB.insert(NewsDBContract.DataBaseEntry.TABLE_NAME,
					null, values);
			break;
		default:
			throw new IllegalArgumentException("Unknown URI: " + uri);
	...
	public boolean onCreate() {
		dbHelper = new NewsDBHelper(getContext(), 1);
		return false;
	}
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		queryBuilder.setTables(NewsDBContract.DataBaseEntry.TABLE_NAME);
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		case CODE:
			rowsUpdated = sqlDB.update(
					NewsDBContract.DataBaseEntry.TABLE_NAME, values,
	...
	private void checkColumns(String[] projection) {
		...
		if (projection != null) {
			...
			HashSet<String> availableColumns = new HashSet<String>(
					Arrays.asList(NewsDBContract.DataBaseEntry.available));
			...
			try {
				for (ContentValues cv : values) {
					long newID = db.insertOrThrow(
							NewsDBContract.DataBaseEntry.TABLE_NAME, null,
							cv);
