 ...
 * 
 */
public class FavouritesPlayerFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater.inflate(R.layout.fragment_favs_players, container,
				false);
	}
	...
	public void onResume() {
		this.adapter = new FavouritesListViewAdapter((Main)getActivity(), font, MyApp
				...
				.fetchFavouritesTable(Favourite.TYPE_PLAYERS), this);
	...
	public void showIfEmpty() {
		if (adapter.getCount() < 1) {
			emptyText.setText(getResources().getString(
					R.string.favouriteEmptyTextPlayers));
