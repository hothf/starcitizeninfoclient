 ...
 * 
 */
public class FavouritesDBContentprovider extends android.content.ContentProvider {

	private FavouritesDBHelper dbHelper;
	private static final String AUTHORITY = "de.kauz.starcitizen.informer.databases.FavouritesDBContentprovider";
	public static final String BASE_PATH = "favourites";
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		case CODE:
			rowsDeleted = sqlDB.delete(
					FavouritesDBContract.DataBaseEntry.TABLE_NAME, selection,
					selectionArgs);
			break;
		case CODE_ID:
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		switch (uriType) {
		case CODE:
			id = sqlDB.insert(FavouritesDBContract.DataBaseEntry.TABLE_NAME,
					null, values);
			break;
		default:
			throw new IllegalArgumentException("Unknown URI: " + uri);
	...
	public boolean onCreate() {
		dbHelper = new FavouritesDBHelper(getContext(), 1);
		return false;
	}
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		queryBuilder.setTables(FavouritesDBContract.DataBaseEntry.TABLE_NAME);
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		case CODE:
			rowsUpdated = sqlDB.update(
					FavouritesDBContract.DataBaseEntry.TABLE_NAME, values,
	...
	private void checkColumns(String[] projection) {
		...
		if (projection != null) {
			...
			HashSet<String> availableColumns = new HashSet<String>(
					Arrays.asList(FavouritesDBContract.DataBaseEntry.available));
			...
			try {
				for (ContentValues cv : values) {
					long newID = db.insertOrThrow(
							FavouritesDBContract.DataBaseEntry.TABLE_NAME, null,
							cv);
