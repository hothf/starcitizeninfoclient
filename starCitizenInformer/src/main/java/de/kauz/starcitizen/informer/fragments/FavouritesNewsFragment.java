...
public class FavouritesNewsFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater.inflate(R.layout.fragment_favs_news, container, false);
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		this.emptyText = (TextView) getView().findViewById(
				R.id.favouritesEmptyText);
	...
	public void onResume() {
		this.adapter = new FavouritesListViewAdapter((Main)getActivity(), font, MyApp
				...
				.fetchFavouritesTable(Favourite.TYPE_NEWS), this);
	...
	public void showIfEmpty() {
		if (adapter.getFavourites().size() < 1) {
			emptyText.setText(getResources().getString(
					R.string.favouriteEmptyTextNews));
